...
exports.newsletterQuery = (queryParams) => {
  ...
  if (!queryParams.isUpdate) {
    ...
    SET nl_id: ${queryParams.nl.nl_id}, nl.nl_ord = "${queryParams.nl.nl_ord}", nl.nl_date = Date({ year: ${queryParams.nl.nl_date.year}, month: ${queryParams.nl.nl_date.month} , day: ${queryParams.nl.nl_date.day}}) , nl.nl_active = ${queryParams.nl.nl_active}, nl.nl_implemented = ${queryParams.nl.nl_implemented}`;
  }
